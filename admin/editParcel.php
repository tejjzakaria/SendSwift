...
if (isset($_POST['submit'])) {
  ...
  // Update parcel data in database
  $sql = "UPDATE parcels SET recipientName='$recipientName', recipientPhoneNumber='$recipientPhoneNumber', recipientCity='$recipientCity' ,
  recipientAddress='$recipientAddress', status='$status', paymentStatus='$paymentStatus', deliveryDate='$deliveryDate', productPrice='$productPrice', productName='$productName', productWeight='$productWeight', comments='$comments' WHERE id='$id'";
...
<head>
  ...
  <title>Edit Parcel - SendSwift</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Parcels/</span> Update parcel</h4>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="<?php echo $parcelData['id']; ?>">
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="trackingNumber">Tracking Number</label>
                        <div class="col-sm-10">
                          <input type="text" id="trackingNumberInput" name="trackingNumber" class="form-control" value="<?php echo $parcelData['trackingNumber']; ?>" readonly>
                          
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="recipientName">Recipient Name</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="recipientName" placeholder="John Doe"
                            name="recipientName" value="<?php echo $parcelData['recipientName']; ?>"/>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="recipientPhoneNumber">Recipient Phone Number</label>
                        <div class="col-sm-10">
                          <input type="tel" class="form-control" id="recipientPhoneNumber" name="recipientPhoneNumber"
                            placeholder="212 6 00 00 00 00" value="<?php echo $parcelData['recipientPhoneNumber']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="deliveryDate">Delivery Date</label>
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="deliveryDate" name="deliveryDate" value="<?php echo $parcelData['deliveryDate']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="recipientCity">Recipient City</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="recipientCity"
                            placeholder="Enter the recipient's city" name="recipientCity" value="<?php echo $parcelData['recipientCity']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="recipientAddress">Recipient Address</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" placeholder="Enter your full address" id="recipientAddress"
                            name="recipientAddress" ><?php echo $parcelData['recipientAddress']; ?></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="productName" placeholder="Enter the product name"
                            name="productName" value="<?php echo $parcelData['productName']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="productWeight">Product Weight</label>
                        <div class="col-sm-10">
                          <select class="form-select" id="productWeight" name="productWeight">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="productPrice">Product Price</label>
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="productPrice"
                            placeholder="Enter the product price" name="productPrice" value="<?php echo $parcelData['productPrice']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea id="comments" name="comments" class="form-control"
                            placeholder="If you have any special instructions, please list them here."
                            aria-label="If you have any special instructions, please list them here."
                            aria-describedby="basic-icon-default-message2"><?php echo $parcelData['comments']; ?></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" id="status" name="status">
                            <option value="waiting pickup" <?php if ($parcelData['status'] == 'waiting pickup') echo 'selected'; ?>>Waiting Pickup</option>
                            <option value="in transit" <?php if ($parcelData['status'] == 'in transit') echo 'selected'; ?>>In Transit</option>
                            <option value="delivered" <?php if ($parcelData['status'] == 'delivered') echo 'selected'; ?>>Delivered</option>
                            <option value="returned" <?php if ($parcelData['status'] == 'returned') echo 'selected'; ?>>Returned</option>
                      ...
                      <div class="row justify-content-end">
                        <div class="col-sm-10">
                          <input type="submit" class="btn btn-primary" name="submit" value="Update Parcel" />
                        </div>
                      </div>
                    </form>
                  </div>
