...
if(isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO users (email, password, username, fullName, idNumber, phoneNumber, businessName, city, address, websiteLink, bankName, accountNumber) VALUES ('$email', '$password', '$username', '$fullName', '$idNumber', '$phoneNumber', '$businessName', '$city', '$address', '$websiteLink', '$bankName', '$accountNumber')";
...
<head>
  ...
  <title>Add new user - SendSwift</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users/</span> Add new</h4>
                    ...
                    <form method="post">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="idNumber"
                            placeholder="Enter the ID number" name="idNumber" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="Enter the phone number" name="phoneNumber" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="Enter the business name" name="businessName" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="Enter the city" name="city" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            placeholder="Enter the website link" name="websiteLink" required />
                        </div>
                      </div>
                      <div class="row mb-3">
