...
$sql = "SELECT id, email, password, username, fullName, idNumber, phoneNumber, businessName, city, address, websiteLink, bankName, accountNumber FROM users";
...
<head>
  ...
  <title>List Users - SendSwift</title>
