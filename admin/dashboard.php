...
$sql = "SELECT COUNT(*) AS total FROM parcels";
$result = mysqli_query($conn, $sql);
$totalParcels = mysqli_fetch_assoc($result)['total'];

$sql = "SELECT COUNT(*) AS delivered FROM parcels WHERE status='delivered'";
$result = mysqli_query($conn, $sql);
$deliveredParcels = mysqli_fetch_assoc($result)['delivered'];

$sql = "SELECT COUNT(*) AS inTransit FROM parcels WHERE status='in transit'";
$result = mysqli_query($conn, $sql);
$inTransitParcels = mysqli_fetch_assoc($result)['inTransit'];

$sql = "SELECT COUNT(*) AS returned FROM parcels WHERE status='returned'";
$result = mysqli_query($conn, $sql);
$returnedParcels = mysqli_fetch_assoc($result)['returned'];

$sql = "SELECT COUNT(*) AS waitingPickup FROM parcels WHERE status='waiting pickup'";
$result = mysqli_query($conn, $sql);
