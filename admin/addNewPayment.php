...
if(isset($_POST['submit'])) {
  ...
  // Insert the data into the payments2 table
  $sql = "INSERT INTO payments2 (userID, paymentAmount, date, status) VALUES ('$userID', '$paymentAmount', '$date', '$status')";
...
<head>
  ...
  <title>Add New Payment - SendSwift</title>
...
<body>
                      ...
                      <form id="formAccountSettings" method="POST">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="date" name="paymentDate" id="paymentDate" placeholder="Date" required/>
                          </div>
                          <div class="mb-3 col-md-6">
  ...
  ?>
                        ...
                        <div class="mt-2">
                          <input type="submit" class="btn btn-primary" name="submit" value="Add Payment" />
