...
$trackingNumber = strtoupper(substr(md5(uniqid(rand(), true)), 0, 10));
...
if(isset($_POST['submit'])) {
  ...
  // insert the data into the parcels table
  $query = "INSERT INTO parcels (userID, trackingNumber, recipientName, recipientPhoneNumber, deliveryDate, recipientCity, recipientAddress, productName, productWeight, productPrice, comments, status, paymentStatus) VALUES ('$userID', '$trackingNumber', '$recipientName', '$recipientPhoneNumber', '$deliveryDate', '$recipientCity', '$recipientAddress', '$productName', '$productWeight', '$productPrice', '$comments', '$status', '$paymentStatus')";
  ...
  if($result) {
    // Redirect to success page after 4 seconds
    sleep(4);
    header('Location: viewParcels.php');
    exit;
  } else {
    $message = "<p class='alert alert-danger'>Error inserting data:</p> " . mysqli_error($conn);
  }
}
?>
...
<head>
  ...
  <title>Add New Parcel - SendSwift</title>
...
<body>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Parcels/</span> Add new</h4>
                  ...
                  <div class="card-body">
                    ...
                    <form method="post">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" id="trackingNumberInput" name="trackingNumber" class="form-control" readonly>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="recipientCity"
                            placeholder="Enter the recipient's city" name="recipientCity" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" placeholder="Enter your full address" id="recipientAddress"
                            name="recipientAddress" required></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" id="productWeight" name="productWeight" required>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="productPrice"
                            placeholder="Enter the product price" name="productPrice" required />
                        </div>
                      </div>
                      <div class="row mb-3">
  ...
  <script>
    ...
    let trackingNumberInput = document.getElementById('trackingNumberInput');
