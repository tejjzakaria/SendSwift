...
if(isset($_POST['search'])) {
  ...
  // Run search query on parcels table
  $sql = "SELECT * FROM parcels WHERE trackingNumber = '$searchTerm'";
  $result = mysqli_query($conn, $sql);

  // Redirect to viewParcels page with search results as query parameter
  header("Location: viewParcels.php?searchTerm=$searchTerm");
  exit();
}
			...
			<tbody>
				<?php while ($row = mysqli_fetch_assoc($result)): ?>
					<tr>
						...
						<td><a href="viewParcel.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">View Details</a></td>
					</tr>
				<?php endwhile; ?>
			</tbody>
		</table>
