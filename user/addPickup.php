...
if (isset($_POST['submit'])) {
  ...
  $parcelsToBePickedup = mysqli_real_escape_string($conn, implode(',', $_POST['parcelsToBePickedup']));

  $requestStatus = "pending";

  // Insert pickup request data into database
  $sql = "INSERT INTO pickupRequests (pickupDate, pickupAddress, parcelsToBePickedup, requestStatus, userID) VALUES ('$pickupDate', '$pickupAddress', '$parcelsToBePickedup', '$requestStatus', '$userID')";
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" placeholder="Enter the pickup full address" id="pickupAddress"
            name="pickupAddress" required></textarea>
        </div>
      </div>
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <select class="form-select" id="parcelsToBePickedup" name="parcelsToBePickedup[]" multiple required>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
              <option value="<?php echo $row['recipientName']; ?>:<?php echo $row['trackingNumber']; ?>">Tracking Number : <?php echo $row['trackingNumber']; ?> | Recipient Name : <?php echo $row['recipientName']; ?></option>
            <?php } ?>
          </select>
      ...
      <div class="row justify-content-end">
        <div class="col-sm-10">
          <input type="submit" class="btn btn-primary" name="submit" value="Request Pickup" />
        </div>
      </div>
    </form>
                  </div>
