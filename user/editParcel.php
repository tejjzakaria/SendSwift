...
if (isset($_POST['submit'])) {
  ...
  recipientAddress='$recipientAddress', deliveryDate='$deliveryDate', productPrice='$productPrice', productName='$productName', productWeight='$productWeight',comments='$comments' WHERE id='$id'";
...
$id = $_GET['id'];
$sql = "SELECT * FROM parcels WHERE id='$id' AND userID='$userID'";
$result = mysqli_query($conn, $sql);
                  ...
                  <div class="card-body">
                    ...
                    <form method="post">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" id="trackingNumberInput" name="trackingNumber" class="form-control"
                            value="<?php echo $parcelData['trackingNumber']; ?>" readonly>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="tel" class="form-control" id="recipientPhoneNumber" name="recipientPhoneNumber"
                            ...
                            value="<?php echo $parcelData['recipientPhoneNumber']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="deliveryDate" name="deliveryDate"
                            value="<?php echo $parcelData['deliveryDate']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="recipientCity"
                            placeholder="Enter the recipient's city" name="recipientCity"
                            value="<?php echo $parcelData['recipientCity']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="productPrice"
                            placeholder="Enter the product price" name="productPrice"
                            value="<?php echo $parcelData['productPrice']; ?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
