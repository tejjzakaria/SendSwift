...
$sql = "SELECT COUNT(*) AS total FROM parcels WHERE userID='$userID'";
$result = mysqli_query($conn, $sql);
$totalParcels = mysqli_fetch_assoc($result)['total'];

$sql = "SELECT COUNT(*) AS delivered FROM parcels WHERE userID='$userID' AND status='delivered'";
$result = mysqli_query($conn, $sql);
$deliveredParcels = mysqli_fetch_assoc($result)['delivered'];

$sql = "SELECT COUNT(*) AS inTransit FROM parcels WHERE userID='$userID' AND status='in transit'";
$result = mysqli_query($conn, $sql);
$inTransitParcels = mysqli_fetch_assoc($result)['inTransit'];

$sql = "SELECT COUNT(*) AS returned FROM parcels WHERE userID='$userID' AND status='returned'";
$result = mysqli_query($conn, $sql);
$returnedParcels = mysqli_fetch_assoc($result)['returned'];

$sql = "SELECT COUNT(*) AS waitingPickup FROM parcels WHERE userID='$userID' AND status='waiting pickup'";
$result = mysqli_query($conn, $sql);
...
if (isset($_GET['search'])) {
  ...
  $sql = "SELECT * FROM parcels WHERE userID='$userID' AND trackingNumber LIKE '%$searchQuery%'";
} else {
...
$result = mysqli_query($conn, $sql);
$parcelData = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
<head>
  ...
  <title>Dashboard - SendSwift</title>
      ...
      <div class="layout-page">
        ...
        <nav
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <!-- Search -->
            <a class="social-count">BETA VERSION !</a>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        ...
                        <p class="mb-4">
                          Kindly be advised that this platform is currently in its beta version and as such, it is
                          possible that you may encounter some technical issues. In the event that you experience any
                          problems, we kindly request that you contact our support team for prompt assistance. Thank you
              ...
              <div class="col-lg-4 col-md-4 order-1" style="width: 100%;">
                <div class="row">
                      ...
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../assets/img/icons/unicons/delivered.png" alt="chart success" class="rounded" />
                          </div>

                        </div>
                        <span class="fw-semibold d-block mb-1">Delivered</span>
                        <h3 class="card-title mb-2"><?php echo $deliveredParcels ?></h3>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../assets/img/icons/unicons/pending.png" alt="Credit Card" class="rounded" />
                          </div>

                        </div>
                        <span>Waiting Pickup</span>
                        <h3 class="card-title text-nowrap mb-1"><?php echo $waitingPickupParcels ?></h3>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../assets/img/icons/unicons/returned.png" alt="Credit Card" class="rounded" />
                          </div>

                        </div>
                        <span>In Transit</span>
                        <h3 class="card-title text-nowrap mb-1"><?php echo $inTransitParcels ?></h3>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../assets/img/icons/unicons/cancelled.png" alt="Credit Card" class="rounded" />
                          </div>

                        </div>
                        <span>Returned</span>
                        <h3 class="card-title text-nowrap mb-1"><?php echo $returnedParcels ?></h3>
                      </div>
                    </div>
                  </div>
                </div>
